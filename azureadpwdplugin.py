...
class AZADRotator:
    ...
    def rotate(az_ad_admin_record, rotate_record):
        ...
        user_id = rotate_record.login # The Azure user_id either as the object ID (GUID) or the user principal name (UPN) of the target user
        epoch_time = int(time.time())
        new_password = 'NEwPassWord-%s' % epoch_time
